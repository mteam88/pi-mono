...
export class ExtensionRunner {
	...
	bindCore(
		...
		if (actions.appendContextRewrite) this.runtime.appendContextRewrite = actions.appendContextRewrite;
		if (actions.undoContextRewrite) this.runtime.undoContextRewrite = actions.undoContextRewrite;
